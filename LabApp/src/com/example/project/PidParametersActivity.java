...
/**
 * This class implements the Activity of the Pid client 
...
public class PidParametersActivity extends Activity {
	...
	private EditText N;
	private String ip;
	private MyAsyncTaskClientPid taskClient;
	private PidParametersActivity aux = this;
	...
	private Double Td_valor=0.0;
	private Double N_valor=0.0;
	...
	/**
	 * It's the getter of the valor of Td
	 *
	 * @return The Td valor
	 */
	public Double getTd_valor() {
		return Td_valor;
	}

	/**
	 * It's the setter of the valor of Td
	 * 
	 * @param td_valor This value will be assign to the field that have the valor of Td
	 */
	public void setTd_valor(Double td_valor) {
		Td_valor = td_valor;
	}
	
	/**
	 * It's the getter of the valor of N
	 *
	 * @return The N valor
	 */
	...
	/**
	 * It's the setter of the valor of N
	 * 
	 * @param n_valor This value will be assign to the field that have the valor of N
	 */
	...
	/**
	 * It's the getter of the valor that is written in the TextField of Td
	 *
	 * @return The valor that is written in the TextField of Td, if there is not a value it return 1.0
	 */
	public Double getTd() {
		Double aux;
		try{
			aux = Double.parseDouble(Td.getText().toString()); 
		}catch(Exception e){
			aux=1.0;
		}
		return aux;
	...
	/**
	 * It's the setter of the valor in the TextField of Td
	 * 
	 * @param Td The new value 
	 */
	public void setTd(Double Td) {
		this.Td.setText(Td.toString());
	}
	
	/**
	 * It's the getter of the valor that is written in the TextField of N
	 *
	 * @return The valor that is written in the TextField of N, if there is not a value it return 1.0
	 */
	public Double getN() {
		Double aux;
		try{
			aux = Double.parseDouble(N.getText().toString()); 
		}catch(Exception e){
			aux=1.0;
		}
		return aux;
	...
	/**
	 * It's the setter of the valor in the TextField of N
	 * 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pid_parameters);
		
		advanceOptions = (Button) findViewById(R.id.buttonAdvanceOptions_PID);
		startControl = (Button) findViewById(R.id.buttonStartControl_PID);
		stopControl = (Button) findViewById(R.id.buttonStopControl_PID);
		updateParameters = (Button) findViewById(R.id.buttonUpdateParameters_PID);
		updateSP = (Button) findViewById(R.id.buttonUpdateSP_PID);
		showGraphic = (Button) findViewById(R.id.buttonShowGraphic_PID);
		sp = (EditText) findViewById(R.id.editTextSP_PID);
		k = (EditText) findViewById(R.id.editTextK_PID);
		Ti = (EditText) findViewById(R.id.editTextTi_PID);
		Td = (EditText) findViewById(R.id.editTextTd_PID);
		N = (EditText) findViewById(R.id.editTextN_PID);
		u = (ProgressBar) findViewById(R.id.progressBarU_PID);
		setU(getU_valor().intValue());
		y = (ProgressBar) findViewById(R.id.progressBarY_PID);
		...
		public void onClick(View v) {
			try{
				...
				bd.dropPID();
				taskClient = new MyAsyncTaskClientPid(aux);
		...
		public void onClick(View v) {
			...
			Intent myIntent = new Intent(PidParametersActivity.this, Graphics.class);
			myIntent.putExtra("regulator", "pid");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_pid_parameters, menu);
		return true;
	}
	...
	*/
	...
	public boolean onKeyDown(int keyCode, KeyEvent event)
	{
		...
		{
			Intent myIntent = new Intent(PidParametersActivity.this, RegulatorActivity.class);
    		finish();
			startActivity(myIntent); 
