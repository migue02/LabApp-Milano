...
/**
 * This class implements the AsyncTask of the Server Sop
...
public class MyAsynTaskServerSop extends AsyncTask<Void, Integer, Boolean> {
	...
	private Double u;
	private Double y;
	private SopParametersActivity activitySop=null;
	private String recived;
	
	
	/**
     * Constructor that associate the field SopActivity of the class
     * with the SopParametersActivity that has create this AsyncTask
     *
     * @param a the SopParametersActivity that has create this AsyncTask
     */
	public MyAsynTaskServerSop(SopParametersActivity a){
		activitySop=a;
	}
			...
			try {
			    ...
			    try {
			    	if(recived.equals("Conect"))
			    		...
			    		y=activitySop.computeY();//I compute "Y"...
			    		...
			    		activitySop.setU_valor(u);//Update "U" valor
			    	}
			    	publishProgress();
				} catch (IOException e) {
	...
	* 
	* This functions change the values of the fields "y" and "u" of the SopActivity with the datum that the
	...
	*/
    ...
    protected void onProgressUpdate(Integer... progress) {
		if(recived.equals("Conect")){
			...
			activitySop.setY(y.intValue()); //Update "Y" bar
			activitySop.setU(u.intValue());//Update "U" bar
	...
	*/
	...
	/**
	 * It's the getter of the context of the SopParametersActivity that has called this AsyncTask
	 *
	 * @return The context of the SopParametersActivity that has called this AsyncTask
	 */
	...
	/**
	 * It's the setter of the context of the SopParametersActivity that has called this AsyncTask
