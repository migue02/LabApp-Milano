...
/**
 * This class implements the Activity of the Fop Server
 ...
 *                           
 */
public class FopParametersActivity extends Activity {
	
	final Context context = this;
	private Button advanceOptions;
	private Button stopSimulation;
	private Button updateParameters;
	private FopParametersActivity aux = this;
	private MyAsynTaskServerFop taskServer;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fop_parameters);
		advanceOptions = (Button) findViewById(R.id.buttonAdvanceOptions_FOP);
		stopSimulation = (Button) findViewById(R.id.buttonStopSimulation_FOP);
		updateParameters = (Button) findViewById(R.id.buttonUpdateParameters_FOP);
		T = (EditText) findViewById(R.id.editTextT_FOP);
		mu = (EditText) findViewById(R.id.editTextMU_FOP);
		u = (ProgressBar) findViewById(R.id.progressBarU_FOP);
		setU(getU_valor().intValue());
		y = (ProgressBar) findViewById(R.id.progressBarY_FOP);
		...
		public void onClick(View v) {
				try{
			        ...
			        if(stopSimulation.getText().equals("Stop Simulation")){
			        	...
			        	taskServer = new MyAsynTaskServerFop(aux);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_fop_parameters, menu);
		return true;
	}
	...
	*/
	...
	public boolean onKeyDown(int keyCode, KeyEvent event)
	{
		...
		{
			Intent myIntent = new Intent(FopParametersActivity.this, ProcessActivity.class);
    		finish();
	...
	*/
	public Double computeY() {
		...
		/*
		 * To compute the new value of y for a FOP you can define a variable
		 * 
		 * p = 1-Ts/T;
		 * 
		 * where Ts is the parameter present in the advanced options, 
		 * and T is the parameter in the main interface of the FOP. 
		 * Then, to compute the next value of y, you can use the formula
		 * 
		 * y = p*y + (1-p)*mu*u;
		 * 
		 * where mu is the parameter present in the main interface of the FOP, 
