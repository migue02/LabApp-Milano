...
/**
 * This class implements the AsyncTask of the Server Fopdt
...
public class MyAsynTaskServerFopdt extends AsyncTask<Void, Integer, Boolean> {
	...
	private Double u;
	private Double y;
	private FopdtParametersActivity activityFOPDT=null;
	private String recived;
	

	/**
     * Constructor that associate the field FopActivity of the class
     * with the FopdtParametersActivity that has create this AsyncTask
     *
     * @param a the FopdtParametersActivity that has create this AsyncTask
     */
	public MyAsynTaskServerFopdt(FopdtParametersActivity a){
		activityFOPDT=a;
	}
	...
	protected Boolean doInBackground(Void... params) {
		...
		while(!activityFOPDT.isStopped()){
			try {
			    ...
			    /*2*/	y=activityFOPDT.computeY();//I compute "Y"...
			    /*3*/	dataOutputStream.writeUTF(y.toString());// I send "Y"...
			    		recived="A";
			    		while(recived.equals("A")) //While I don't recive a number "U"...
			    			recived=dataInputStream.readUTF();
			    		u=Double.parseDouble(recived);//I've recived "U"
			    		activityFOPDT.setU_valor(u);//Update "U" valor
			    	}
			    	publishProgress();
				} catch (IOException e) {
	...
	*/
    ...
    protected void onProgressUpdate(Integer... progress) {
		if(recived.equals("Conect")){
			...
			activityFOPDT.setY(y.intValue()); //Update "Y" bar
			activityFOPDT.setU(u.intValue());//Update "U" bar
	...
	*/
	...
	/**
	 * It's the getter of the context of the FopdtParametersActivity that has called this AsyncTask
	 *
	 * @return The context of the FopdtParametersActivity that has called this AsyncTask
	 */
	...
	/**
	 * It's the setter of the context of the FopdtParametersActivity that has called this AsyncTask
